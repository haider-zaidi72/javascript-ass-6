...
function colorValueName (){


    let randomValue = colorName[Math.floor(Math.random()*colorName.length)]
...
let text = document.getElementById("color");
    ...
    document.body.innerHTML+= `<h3>Current background: ${randomValue}</h3>`
}
